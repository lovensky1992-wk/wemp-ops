...
| 特征 | 示例 | 改写方向 |
|------|------|---------|
| 对称句式 | "不仅…而且…"、"既…又…" 超过 2 次 | 打破对称，用不规则表达 |
| 转折万能词 | "然而"、"不过值得注意的是" | 换成口语："但说实话"、"话说回来" |
| 总结套话 | "综上所述"、"总而言之" | 删掉，直接说结论 |
| 过度礼貌 | "让我们一起来看看" | 删掉导航词，直接切入 |
| 列表强迫症 | 动不动 "第一…第二…第三…" | 用叙事串联，减少编号 |
| 四字成语堆砌 | "应运而生"、"如火如荼"、"方兴未艾" | 用大白话替代 |
| 假设性修辞 | "想象一下…" | 换成真实案例："上周我就碰到了…" |
| 情感注入过度 | "令人兴奋的是"、"值得一提的是" | 删掉修饰，让内容本身说话 |
